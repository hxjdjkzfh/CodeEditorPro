...
# 1. Собираем APK через создание корректного APK с DEX файлом
echo -e "${BLUE}[+] Запуск сборки APK с корректным DEX файлом...${NC}"
./create_full_working_apk.sh

# Копируем APK с нужными именами
cp codeeditor-working.apk code-editor.apk
cp codeeditor-working.apk code-editor-pro.apk
